...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['v1Hub'] = this.createHubProxy('v1Hub'); 
        proxies['v1Hub'].client = { };
        proxies['v1Hub'].server = {
            sendMessage: function (minorToken, message) {
                return proxies['v1Hub'].invoke.apply(proxies['v1Hub'], $.merge(["SendMessage"], $.makeArray(arguments)));
             }
        };
